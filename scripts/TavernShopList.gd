...
func _get_drag_data(at_position: Vector2):
	...
	return { "id": id, "from": "shop_tavern", "kind": kind }
...
func _can_drop_data(at_position: Vector2, data) -> bool:
	...
	# Acepta drops DESDE inventario (vender)
	return from == "inventory" and kind == "item"
...
func _drop_data(at_position: Vector2, data) -> void:
	...
	if scene and scene.has_method("on_drop_tavern_from_inventory"):
		scene.call("on_drop_tavern_from_inventory", id)
